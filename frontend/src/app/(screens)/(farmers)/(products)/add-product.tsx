// app/(farmers)/(products)/add-product.tsx
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const productData = {
        ...
        // In a real app, you'd upload images to a service like Cloudinary
        image: images.main.uri,
        image1: images.image1?.uri || null,
        image2: images.image2?.uri || null,
      };
        ...
        >
          <View style={styles.container}>
            ...
            <View style={styles.imageSection}>
              ...
              <Text style={styles.sectionSubtitle}>Add at least one main image</Text>
