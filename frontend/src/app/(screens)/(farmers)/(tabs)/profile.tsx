...
const Profile = () => {
  ...
  const { user, logout } = useAuth(); // Use real user from auth context

  // Use actual user data
  const userProfile = {  
    id: user?.id || 0,
    fullname: user?.fullName || 'Farm Owner',
          ...
          >
            ...
            <View style={styles.profilefooter}>
              ...
              <View style={styles.header}>
                <Text style={styles.headertext}>{userProfile.fullname}</Text>              
                <Text style={styles.headersubtext}>{userProfile.username}</Text>
